    ...
    <div className="min-h-screen bg-white flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-blue-900">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center z-20 text-white p-12 text-center">
          <h1 className="text-5xl font-extrabold tracking-tight mb-4 text-shadow-lg">HRMS<span className="text-blue-300">Pro</span></h1>
          <p className="text-xl max-w-md opacity-90 text-shadow-md">
            The intelligent platform for modern human resource management. Connect, manage, and empower your workforce.
          </p>
        </div>
      </div>
